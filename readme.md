...
- **Dual-Source Retrieval**: Captures both *behavioral co-occurrence* (via Implicit Alternating Least Squares) and *content semantics* (via Transformer embeddings + FAISS).
...
├── RENET.ipynb                   # Complete development notebook
